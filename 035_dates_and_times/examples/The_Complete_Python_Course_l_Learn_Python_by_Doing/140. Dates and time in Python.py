"""
Working with dates and times is an extremely useful skill, and it can sometimes be a bit confusing.
In this video we look at simplifying working with dates and times slightly using Python built-in modules.

The main date and time module in python is called `datetime`, and confusingly enough the main class in that
module is also called `datetime`.
"""
...
That way, you only have to deal with timezones when you show a time to a user; and you don’t have to work 
with timezones at any other point in your system.
...
"""
For a cheatsheet on date parsing and formatting, check the resources section of this lecture! 
I’ll be attached there as a PDF.
"""