...
# '10'
print("%d — %d — %d" % (10, 20, 30))     # Несколько элементов
# '10 — 20 — 30'
#
#
print("%(name)s — %(year)s" % {"year": 1978, "name": "Nik"})     # dict
# # 'Nik — 1978'
#
#
print("%#o %#o %#o" % (0o77, 10, 105))    # oct
# 0o77 0o12 0o12
print("%#x %#x %#x" % (0xff, 10, 105))    #  hexadecimal
# 0xff 0xa 0xa
print("%#X %#X %#X" % (0xff, 10, 105))    # hexadecimal with big O
# # 0XFF 0XA 0XA
print("%#.0F %.0F" % (300, 300))          # tochnost' # для вещественных чисел предписывает всегда выводить дробную
...
print("'%d' — '%05d'" % (3, 3))  # 5 — ширина поля | digit
# # "'3' — '00003'"
#
...
print("'%5d' — '%-5d'" % (3, 3))  # 5 — ширина поля | digit
# # "'    3' — '3    '"
print("'%05d' — '%-5d'" % (3, 3))   # 5 — ширина поля | digit
# # "'00003' — '3    '"
#
