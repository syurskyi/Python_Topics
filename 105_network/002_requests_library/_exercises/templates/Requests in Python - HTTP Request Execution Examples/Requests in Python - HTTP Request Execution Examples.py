...
#
# response _ ?.g.. 'https://api.github.com'
#
...
# ____ ?.e__ ______ H_E..
#
# ___ url __ 'https://api.github.com', 'https://api.github.com/invalid'
#     ___
#         response _ ?.g.. ?
#
#         # если ответ успешен, исключения задействованы не будут
#         ?.r_f_s..
#     _____ H_E.. __ http_err:
#         print(f'HTTP error occurred: |? ')  # Python 3.6
#     _____ E.. __ err:
#         print(f'Other error occurred: ? ')  # Python 3.6
#     ____
#         print('Success!')
#
...
# # .encoding перед .text.
#
# ?.e.. _ 'utf-8' # Optional: requests infers this internally
# ?.t..
# # '{"current_user_url":"https://api.github.com/user","current_user_authorizations_html_url":"https://github.com/
...
#     params_{'q': 'requests+language:python'},
# )
#
# # Анализ некоторых атрибутов местонахождения запросов
# json_response _ ?.j..
# repository _ ? 'items' 0
# print _*Repository name: ? "name" ')  # Python 3.6+
# print _*Repository description: ? "description"  ')  # Python 3.6+
#
...
# ?.g..(
#     'https://api.github.com/search/repositories',
#     params_b'q=requests+language:python',
# )
# # <Response [200]>
#
...
#     'https://api.github.com/search/repositories',
#     params_{'q': 'requests+language:python'},
#     h.._{'Accept': 'application/vnd.github.v3.text-match+json'},
# )
#
...
# json_response _ ?.j..
# repository _ ? 'items' 0
# print _*Text matches: ? "text_matches" '
#
...
#
#
# ?.p.. 'https://httpbin.org/post', d.._ 'key':'value'
# ?.p.  'https://httpbin.org/put', d.._ 'key':'value'
# ?.d.. 'https://httpbin.org/delete'
# ?.h.. 'https://httpbin.org/get')
# ?.p.. 'https://httpbin.org/patch', d.._ 'key':'value'
# ?.o.. 'https://httpbin.org/get')
#
...
#
# response _ ?.h.. 'https://httpbin.org/get'
# ?.h.. 'Content-Type'
# # 'application/json'
#
# response _ ?.d.. 'https://httpbin.org/delete')
# json_response _ ?.j..
# ? 'args'
# # {}
#
...
#
# response _ ?.p.. 'https://httpbin.org/post', j.._ 'key':'value'
# json_response _ ?.j..
# ? 'data'
# # '{"key": "value"}'
...
#
# ____ g_p.. ______ g_p..
# ?.g.. 'https://api.github.com/user' a.._ 'username', g_p..
# # <Response [200]>
#
...
#         r.h..['X-TokenAuth'] _ _*|t.. '  # Python 3.6+
#         r_ ?
#
#
# ?.g.. 'https://httpbin.org/get' a_TA.. '12345abcde-token'
#
...
#
# ?.g.. 'https://api.github.com' t.._1
# # <Response [200]>
# ?.g.. 'https://api.github.com' t.._3.05
# # <Response [200]>
#
...
#
# ?.g..('https://api.github.com' t.._ 2, 5
# # <Response [200]>
#
...
#
# ___
#     response _ ?.g..('https://api.github.com', t.._1
# _____ T..
...
#     response _ ?.g.. 'https://api.github.com/user'
#
