...
___ myNetwork
    ...
    h9 _ net.addHost('h9', cls_Host, ip_'10.0.0.9', defaultRoute_None)
    h1 _ net.addHost('h1', cls_Host, ip_'10.0.0.1', defaultRoute_None)
    h7 _ net.addHost('h7', cls_Host, ip_'10.0.0.7', defaultRoute_None)
    h10 _ net.addHost('h10', cls_Host, ip_'10.0.0.10', defaultRoute_None)
    h2 _ net.addHost('h2', cls_Host, ip_'10.0.0.2', defaultRoute_None)
    h6 _ net.addHost('h6', cls_Host, ip_'10.0.0.6', defaultRoute_None)
    h4 _ net.addHost('h4', cls_Host, ip_'10.0.0.4', defaultRoute_None)
    h11 _ net.addHost('h11', cls_Host, ip_'10.0.0.11', defaultRoute_None)
    h8 _ net.addHost('h8', cls_Host, ip_'10.0.0.8', defaultRoute_None)
    h5 _ net.addHost('h5', cls_Host, ip_'10.0.0.5', defaultRoute_None)
