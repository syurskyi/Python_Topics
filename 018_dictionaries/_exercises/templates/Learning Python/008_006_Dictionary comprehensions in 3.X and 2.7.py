...
# D = x x ** 2 ___ ? __ |1, 2, 3, 4     # Or: range(1, 5)
# print ?
#
# print('#' * 52 + ' Loop over any iterable')
# D = c c * 4 ___ ? __ 'SPAM'            # Loop over any iterable
# print ?
#
# D = c.l.. ? + '!' ___ ? __ 'SPAM', 'EGGS', 'HAM'
# print(D)
#
...
# D =  k 0 ___ ? _ 'a', 'b', 'c'          # Same, but with a comprehension
# print ?
#
# print('#' * 52 + ' Other iterators, default value')
# D = di__.f.k. spam                   # Other iterators, default value
# print ?
#
# D =  k N.. ___ ? __ spam
# print ?
