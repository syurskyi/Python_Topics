...
c_ Cube(Square):
    ___ area
        face_area _ self.side * self.side
        return face_area * 6
...
c_ SquarePrism(Square):
     ...
     ___ face_area
         ...
         lateral_area _ self.side * self.height
