...
#
# w___ o... r"file.txt", "w", e..._"cp1251"  a_ f
#     f.w... "Строка"   # Записываем строку в файл
...
# # записи и чтении файла, позволяет параметр e....
#
...
#
# f _ o... _ file.txt _         # Открываем файл для чтения
# ?.w.a.
# # False
# # ######################################################################################################################
#
# f _ o... file.txt __        # Открываем файл для записи
# ?.w.a.
# # True
# # ######################################################################################################################
#
...
#
# # Текстовый режим
# w___ o... _ file.txt _ e..._"cp1251"  a_ f:
#     ?.r..
#
# 'Строка1\nСтрока2'
# # Бинарный режим
# w___ o... _ file.txt __  a_ f
#     ?.r..
...
# # ######################################################################################################################
#
# f _ o... _ file.txt __ e..._"cp1251"
# ?.r..
# # 'Строка1\nСтрока2'
# # ######################################################################################################################
# # truncate ([<Количество>]
...
#
# f _ o... _ file.txt _ e..._"cp1251"
# ?.t..        # Указатель расположен в начале файла
# # 0
# # ######################################################################################################################
#
...
# # ######################################################################################################################
#
# ?.t..        # Теперь значение соответствует
# # 9
# ?.c...
# # ######################################################################################################################
...
#
# _______ i.
# i_.S_S i_.S._C. i_.S._E.
# #  0, 1, 2
# # ######################################################################################################################
#
# _______ i.
# f _ o... _ file.txt __
# ?.s 9 i_.S._C.   # 9 байтов от указателя
# # 9
# # ######################################################################################################################
#
# ?.t...
# # 9
# # ######################################################################################################################
# ?.s.. 0 i_.S.._S.   # Перемещаем указатель в начало
# # 0
# # ######################################################################################################################
# ?.t..
# # 0
# # ######################################################################################################################
# ?.s.. -9 i_.S._E.   # -9 байтов от конца файла
# # 7
# # ######################################################################################################################
# ?.t..
# # 7
...
# #
# # Стандартный вывод stdout также является файловым объектом. Атрибут e... этого объекта всегда содержит кодировку
...
# # атрибут e... будет иметь значение "ср866", а при запуске в окне Python Shell редактора IDLE - значение " ср1251 ".
#
# f _ o... _ file.txt _ e..._"cp1251"
# ?.e...
# # 'cp1251'
