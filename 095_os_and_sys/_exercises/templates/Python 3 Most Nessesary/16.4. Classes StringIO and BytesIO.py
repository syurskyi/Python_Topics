...
# ?.t...          # Позиция указателя
# # 0
# ?.s... 0, 2     # Перемещаем указатель в конец файла
# # 8
# ?.t...          # Позиция указателя
# # 8
# ?.s... 0        # Перемещаем указатель в начало файла
# # 0
# ?.t...          # Позиция указателя
# # 0
# ?.c...         # Закрываем файл
...
#
# f _ __.S "String1\nString2\nString3"
# ?.s... 15          # Перемещаем указатель
# # 15
# ?.tr..        # Обрезаем файл до указателя
# # 15
# ?.g...         # Получаем содержимое файла
# # 'String1\nString2'
# ?.c...            # Закрываем файл
...
# # b'P'
# b.. 0 _ _"J"         # Изменяем значение по индексу
# ?.g...            # Получаем содержимое
# # b'Jython'
# b__.t.l.            # Преобразуем в список чисел
# # [74, 121, 116, 104, 111, 110]
# b__.t.b.           # Преобразуем в тип bytes
# # b'Jython'
# ?.c...               # Закрываем файл
# # ######################################################################################################################