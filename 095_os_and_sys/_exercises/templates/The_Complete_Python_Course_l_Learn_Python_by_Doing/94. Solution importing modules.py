____ addition ______ Addition


class Calculator:
    @classmethod
    ___ add(cls, num1, num2):
        r_ Addition.add(num1, num2)  # make use of add() from Addition module

    @classmethod
    ___ subtract(cls, num1, num2):
        r_ cls.add(num1, -num2)  # turn subtraction to adding a negative num2
