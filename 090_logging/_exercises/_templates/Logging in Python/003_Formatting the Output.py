...
# ______ l____
#
# l____.bC.. f.._'_(pr..)d-_(l_n..)_-_(m..)s'
# l____.w.. This is a Warning
...
# ______ l____
#
# l____.bC.. f.._'_(a_t_)_ - _(m..)_', l.._l____.I..
# l____.i.. Admin logged in
...
# ______ l____
#
# l____.bC.. f.._'_(a_t_)_ - _(m..)_', datefmt_'%d-%b-%y %H:%M:%S'
# l____.w.. Admin logged out
