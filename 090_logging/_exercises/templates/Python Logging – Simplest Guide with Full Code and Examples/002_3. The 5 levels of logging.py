...
______ l____
l____.basicConfig(level=l____.WARNING)
...
l____.debug("a = {a}, b = {b}".format(**kwargs))
l____.info("Hypotenuse of {a}, {b} is {c}".format(**kwargs))
l____.warning("a={a} and b={b} are equal".format(**kwargs))
l____.error("a={a} and b={b} cannot be negative".format(**kwargs))
l____.critical("Hypotenuse of {a}, {b} is {c}".format(**kwargs))
