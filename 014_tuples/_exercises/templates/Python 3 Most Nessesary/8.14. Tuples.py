...
#
#
# ___                # Создаем пустой кортеж
# # ()
# ____ String       # Преобразуем строку в кортеж
# # ('S', 't', 'r', 'i', 'n', 'g')
# print ___ 1, 2, 3, 4, 5 # Преобразуем список в кортеж
# # (1, 2, 3, 4, 5)
#
#
# t1 = __        # Создаем пустой кортеж
...
#
# t = (1, 2, 3, 4, 5, 6, 7, 8, 9)
# print ? 0                  # Получаем значение первого элемента кортежа
# # 1
# print ? -1               # Изменяем порядок следования элементов
# # (9, 8, 7, 6, 5, 4, 3, 2, 1)
# print ? 2 5                # Получаем срез
# # (3, 4, 5)
# print(8 _ ?, 0 __ ?        # Проверка на вхождение
# # (True, False)
...
# # 3
# t = (1, 2, 1, 2, 1)
# print ?.i.. 1 ?.i.. 2 # Ищем элементы в кортеже
# # (0, 1)