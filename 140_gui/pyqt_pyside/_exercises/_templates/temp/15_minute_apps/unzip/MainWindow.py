...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        head.setText("")
        head.setPixmap(QtGui.QPixmap("images/cat-head-glasses.png"))
        head.setAlignment(QtCore.Qt.AlignCenter)
        head.setObjectName("head")
        verticalLayoutWidget = QtWidgets.QWidget(widget)
...
"}")
        ...
        body.setText("")
        body.setPixmap(QtGui.QPixmap("images/cat-body-space.png"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        progress_4.setText(_translate("MainWindow", "7PEZ"))
        progress_5.setText(_translate("MainWindow", "7PEZ"))
        progress_6.setText(_translate("MainWindow", "7PEZ"))
        progress_7.setText(_translate("MainWindow", "7PEZ"))
        progress_8.setText(_translate("MainWindow", "7PEZ"))
        progress_9.setText(_translate("MainWindow", "7PEZ"))
        progress_10.setText(_translate("MainWindow", "7PEZ"))
