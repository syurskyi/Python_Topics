...
"}")
        ...
        fileBar.aW..(progress_1)
        progress_2 _ ?W...QLabel(verticalLayoutWidget)
        font _ ?G...?F..()
        font.sPS..(8)
        progress_2.sF..(font)
...
"}")
        ...
        fileBar.aW..(progress_2)
        progress_3 _ ?W...QLabel(verticalLayoutWidget)
        font _ ?G...?F..()
        font.sPS..(8)
        progress_3.sF..(font)
...
"}")
        ...
        fileBar.aW..(progress_3)
        progress_4 _ ?W...QLabel(verticalLayoutWidget)
        font _ ?G...?F..()
        font.sPS..(8)
        progress_4.sF..(font)
...
"}")
        ...
        fileBar.aW..(progress_4)
        progress_5 _ ?W...QLabel(verticalLayoutWidget)
        font _ ?G...?F..()
        font.sPS..(8)
        progress_5.sF..(font)
...
"}")
        ...
        fileBar.aW..(progress_5)
        progress_6 _ ?W...QLabel(verticalLayoutWidget)
        font _ ?G...?F..()
        font.sPS..(8)
        progress_6.sF..(font)
...
"}")
        ...
        fileBar.aW..(progress_6)
        progress_7 _ ?W...QLabel(verticalLayoutWidget)
        font _ ?G...?F..()
        font.sPS..(8)
        progress_7.sF..(font)
...
"}")
        ...
        fileBar.aW..(progress_7)
        progress_8 _ ?W...QLabel(verticalLayoutWidget)
        font _ ?G...?F..()
        font.sPS..(8)
        progress_8.sF..(font)
...
"}")
        ...
        fileBar.aW..(progress_8)
        progress_9 _ ?W...QLabel(verticalLayoutWidget)
        font _ ?G...?F..()
        font.sPS..(8)
        progress_9.sF..(font)
...
"}")
        ...
        fileBar.aW..(progress_9)
        progress_10 _ ?W...QLabel(verticalLayoutWidget)
        font _ ?G...?F..()
        font.sPS..(8)
        progress_10.sF..(font)
...
"}")
        ...
        fileBar.aW..(progress_10)
        body _ ?W...QLabel(widget)
        body.setGeometry(?C...QRect(20, 120, 191, 381))
        body.sT..("")
        body.sP..(?G...?P..("images/cat-body-space.png"))
        body.setObjectName("body")
        verticalLayoutWidget.raise_()
        body.raise_()
        head.raise_()
        verticalLayout.aW..(widget)
    ...
    ___ retranslateUi  MainWindow):
        ...
        progress_1.sT..(_translate("MainWindow", "7PEZ"))
        progress_2.sT..(_translate("MainWindow", "7PEZ"))
        progress_3.sT..(_translate("MainWindow", "7PEZ"))
        progress_4.sT..(_translate("MainWindow", "7PEZ"))
        progress_5.sT..(_translate("MainWindow", "7PEZ"))
        progress_6.sT..(_translate("MainWindow", "7PEZ"))
        progress_7.sT..(_translate("MainWindow", "7PEZ"))
        progress_8.sT..(_translate("MainWindow", "7PEZ"))
        progress_9.sT..(_translate("MainWindow", "7PEZ"))
        progress_10.sT..(_translate("MainWindow", "7PEZ"))
