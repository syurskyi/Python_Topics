...
c_ Ui_MainWindow(object):
    ___ setupUi  MainWindow):
        ...
        previousButton.sT..("")
        icon _ ?G...QIcon()
        icon.addPixmap(?G...?P..("images/control-skip-180.png"), ?G...QIcon.Normal, ?G...QIcon.Off)
        ...
        playButton.sT..("")
        icon1 _ ?G...QIcon()
        icon1.addPixmap(?G...?P..("images/control.png"), ?G...QIcon.Normal, ?G...QIcon.Off)
        ...
        pauseButton.sT..("")
        icon2 _ ?G...QIcon()
        icon2.addPixmap(?G...?P..("images/control-pause.png"), ?G...QIcon.Normal, ?G...QIcon.Off)
        ...
        stopButton.sT..("")
        icon3 _ ?G...QIcon()
        icon3.addPixmap(?G...?P..("images/control-stop-square.png"), ?G...QIcon.Normal, ?G...QIcon.Off)
        ...
        nextButton.sT..("")
        icon4 _ ?G...QIcon()
        icon4.addPixmap(?G...?P..("images/control-skip.png"), ?G...QIcon.Normal, ?G...QIcon.Off)
        ...
        viewButton.sT..("")
        icon5 _ ?G...QIcon()
        icon5.addPixmap(?G...?P..("images/application-image.png"), ?G...QIcon.Normal, ?G...QIcon.Off)
        ...
        label.sT..("")
        label.setPixmap(?G...?P..("images/speaker-volume.png"))
