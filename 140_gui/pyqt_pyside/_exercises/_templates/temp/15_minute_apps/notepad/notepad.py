...
class MainWindow(QMainWindow):
    ...
    ___ __init__(self, *args, **kwargs):
        ...
        self.editor _ QPlainTextEdit()  # Could also use a QTextEdit and set self.editor.setAcceptRichText(False)
    ...
    ___ file_open(self):
        path, _ _ QFileDialog.getOpenFileName(self, "Open file", "", "Text documents (*.txt);All files (*.*)")
    ...
    ___ file_saveas(self):
        path, _ _ QFileDialog.getSaveFileName(self, "Save file", "", "Text documents (*.txt);All files (*.*)")
