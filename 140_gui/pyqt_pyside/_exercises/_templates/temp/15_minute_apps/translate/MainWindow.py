...
c_ Ui_MainWindow o..
    ___ setupUi  MainWindow):
        ...
        srcLanguage _ ?W...?CB(centralwidget)
        srcLanguage.setObjectName("srcLanguage")
        verticalLayout.aW..(srcLanguage)
        srcTextEdit _ ?W...?TE..(centralwidget)
        srcTextEdit.setObjectName("srcTextEdit")
        verticalLayout.aW..(srcTextEdit)
        horizontalLayout.aL..(verticalLayout)
        verticalLayout_3 _ ?W...?VBL..()
        verticalLayout_3.setObjectName("verticalLayout_3")
        translateButton _ ?W...?PB..(centralwidget)
