...
c_ MainWindow(qtw.?MW..):
    ...
    ___  -
        ...
        print_tb.aA..('Export PDF', export_pdf)

        printer _ qtps.QPrinter()
        # Configure defaults:
        printer.setOrientation(qtps.QPrinter.Portrait)
        printer.setPageSize(qtg.QPageSize(qtg.QPageSize.Letter))
