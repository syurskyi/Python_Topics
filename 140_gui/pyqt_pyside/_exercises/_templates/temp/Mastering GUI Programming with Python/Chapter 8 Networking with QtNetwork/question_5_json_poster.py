...
c_ Poster(qtc.?O..):
    ...
    ___ make_request  url, data, filename):
        ...
        multipart _ qtn.?HMP..(qtn.?HMP...FDT..)
    ...
    ___ on_reply  reply):
        ...
        reply_string _ bytes(reply_bytes).d..('utf-8')
...
c_ MainWindow(qtw.?MW..):
    ...
    ___  -
        ...
        widget.sL.. ?.?VBL..
        url _ qtw.?LE..
        table _ qtw.?TW..(columnCount_2, rowCount_5)
        table.horizontalHeader().setSectionResizeMode(
            qtw.?HV...Stretch)
        table.sHHL..(['key', 'value'])
        fname _ qtw.?PB..(
