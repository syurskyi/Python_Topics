...
c_ Ui_StyleSheetEditor(object):
    ___ setupUi  StyleSheetEditor):
        ...
        self.styleSheetCombo.addItem("")
        self.styleSheetCombo.addItem("")
        self.gridlayout.aW..(self.styleSheetCombo, 0, 5, 1, 1)
        ...
        self.gridlayout.aW..(self.styleCombo, 0, 2, 1, 1)
        ...
        self.gridlayout.aW..(self.label_7, 0, 1, 1, 1)
        ...
        self.gridlayout.aW..(self.styleTextEdit, 1, 0, 1, 7)
        ...
        self.gridlayout.aW..(self.label_8, 0, 4, 1, 1)
