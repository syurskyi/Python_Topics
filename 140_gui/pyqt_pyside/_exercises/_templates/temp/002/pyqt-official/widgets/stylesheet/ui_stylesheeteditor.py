...
c_ Ui_StyleSheetEditor(object):
    ___ setupUi  StyleSheetEditor):
        ...
        styleSheetCombo _ ?W...QComboBox(StyleSheetEditor)
        styleSheetCombo.setObjectName("styleSheetCombo")
        styleSheetCombo.addItem("")
        styleSheetCombo.addItem("")
        styleSheetCombo.addItem("")
        ...
        styleCombo _ ?W...QComboBox(StyleSheetEditor)
        ...
        label_7 _ ?W...QLabel(StyleSheetEditor)
        ...
        styleTextEdit _ ?W...QTextEdit(StyleSheetEditor)
        styleTextEdit.setObjectName("styleTextEdit")
        gridlayout.aW..(styleTextEdit, 1, 0, 1, 7)
        label_8 _ ?W...QLabel(StyleSheetEditor)
        sizePolicy _ ?W...QSizePolicy(?W...QSizePolicy.Fixed, ?W...QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
