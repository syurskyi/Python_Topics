...
____ polygonwidget ______ PolygonWidget


c_ PolygonWidgetPlugin(QPyDesignerCustomWidgetPlugin):
    ...
    ___ domXml
        r_ '<widget class="PolygonWidget" name="polygonWidget" />\n'
