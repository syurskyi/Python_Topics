...
c_ Ui_MainWindow(object
    ...
    ___ retranslateUi , MainWindow
        ...
        pB__.sT..(_translate("MainWindow", "PushButton", None))
        ...
        cB__.setItemText(5, _translate("MainWindow", "New Item", None))
        cB__.setItemText(6, _translate("MainWindow", "New Item", None))
        cB__.setItemText(7, _translate("MainWindow", "New Item", None))
        cB__.setItemText(8, _translate("MainWindow", "New Item", None))
        cB__.setItemText(9, _translate("MainWindow", "New Item", None))
        cB__.setItemText(10, _translate("MainWindow", "New Item", None))
        cB__.setItemText(11, _translate("MainWindow", "New Item", None))
        cB__.setItemText(12, _translate("MainWindow", "New Item", None))
        cB__.setItemText(13, _translate("MainWindow", "New Item", None))
        cB__.setItemText(14, _translate("MainWindow", "New Item", None))
        cB__.setItemText(15, _translate("MainWindow", "New Item", None))
