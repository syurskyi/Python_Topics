...
c_ Ui_MainWindow(object
    ___ setupUi , MainWindow
        ...
        ?C...QObject.c..(horizontalSlider, ?C...SIGNAL("valueChanged(int)"), spinBox.sV..)
        ?C...QObject.c..(spinBox, ?C...SIGNAL("valueChanged(int)"), horizontalSlider.sV..)
        ?C...QObject.c..(spinBox, ?C...SIGNAL("valueChanged(int)"), pB__.sV..)
