...
c_ Ui_MainWindow(object
    ...
    ___ retranslateUi , MainWindow
        ...
        pB__.sT..(_translate("MainWindow", "Start", None))
        ...
        cB__.setItemText(0, _translate("MainWindow", "New Item", None))
        cB__.setItemText(1, _translate("MainWindow", "New Item", None))
        cB__.setItemText(2, _translate("MainWindow", "New Item", None))
        cB__.setItemText(3, _translate("MainWindow", "New Item", None))
        cB__.setItemText(4, _translate("MainWindow", "New Item", None))
