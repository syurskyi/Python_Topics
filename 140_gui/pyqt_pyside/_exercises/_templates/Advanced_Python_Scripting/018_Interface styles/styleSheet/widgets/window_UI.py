...
c_ Ui_MainWindow(object
    ___ setupUi , MainWindow
        ...
        ?C...QObject.c..(horizontalSlider, ?C...SIGNAL(_fromUtf8("valueChanged(int)")), spinBox.sV..)
        ?C...QObject.c..(spinBox, ?C...SIGNAL(_fromUtf8("valueChanged(int)")), horizontalSlider.sV..)
        ?C...QObject.c..(spinBox, ?C...SIGNAL(_fromUtf8("valueChanged(int)")), pB__.sV..)
