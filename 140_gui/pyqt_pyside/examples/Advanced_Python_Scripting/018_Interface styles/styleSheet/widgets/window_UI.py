...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuHelop.setObjectName(_fromUtf8("menuHelop"))
        ...
        QtCore.QObject.connect(self.spinBox, QtCore.SIGNAL(_fromUtf8("valueChanged(int)")), self.progressBar.setValue)
        QtCore.QObject.connect(self.radioButton_2, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.treeWidget.setEnabled)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton_2.setText(_translate("MainWindow", "Enable", None))
        self.radioButton.setText(_translate("MainWindow", "Disable", None))
        ...
        self.treeWidget.topLevelItem(3).child(0).setText(0, _translate("MainWindow", "New Subitem", None))
        ...
        self.menuHelop.setTitle(_translate("MainWindow", "Help", None))
