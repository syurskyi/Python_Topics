...
class MyWidget(QtGui.QWidget):
    def __init__(self, parent=None):
        ...
        self.button = QtGui.QPushButton("Сделать панель отдельным окном")
...
class MyWindow(QtGui.QMainWindow):
    ...
    def add_dock_widget(self):
        ...
        self.dw.setAllowedAreas(QtCore.Qt.LeftDockWidgetArea)
        ...
        self.dw2.setAllowedAreas(QtCore.Qt.TopDockWidgetArea |
