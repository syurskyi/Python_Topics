...
class MyWindow(QtGui.QMainWindow):
    ...
    def add_tool_bar(self):
        ...
        self.toolBar.addAction("Close1", QtGui.qApp,
                               QtCore.SLOT("quit()"))
        self.toolBar.addAction("Close2", QtGui.qApp.quit)
        self.toolBar.addAction(ico, "Close3", QtGui.qApp,
                               QtCore.SLOT("quit()"))
        a = self.toolBar.addAction(ico, "Close4", QtGui.qApp.quit)
