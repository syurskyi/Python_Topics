...
scene.changed["const QList<QRectF>&"].connect(on_changed)
scene.sceneRectChanged["const QRectF&"].connect(on_scene_rect_changed)
...
button = QtGui.QPushButton("Изменить размеры сцены")
