...
if __name__ == "__main__":
    a__ Solution().medianSlidingWindow([-2147483648,-2147483648,2147483647,-2147483648,-2147483648,-2147483648,2147483647,2147483647,2147483647,2147483647,-2147483648,2147483647,-2147483648], 2)
    a__ Solution().medianSlidingWindow([1,1,1,1], 2) == [1, 1, 1]
    a__ Solution().medianSlidingWindow([1,3,-1,-3,5,3,6,7], 3) == [1,-1,-1,3,5,6]
