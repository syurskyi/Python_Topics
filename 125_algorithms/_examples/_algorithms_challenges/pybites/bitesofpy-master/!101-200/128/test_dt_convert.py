...
def test_years_ago():
    a__ years_ago('8 Aug, 2015') == 3
    a__ years_ago('6 Sep, 2014') == 4
    a__ years_ago('1 Oct, 2010') == 8
    a__ years_ago('31 Dec, 1958') == 60


def test_years_ago_wrong_input():
    with pytest.raises(ValueError):
        # Sept != valid %b value 'Sep'
        a__ years_ago('6 Sept, 2014') == 4


def test_convert_eu_to_us_date():
    a__ convert_eu_to_us_date('11/03/2002') == '03/11/2002'
    a__ convert_eu_to_us_date('18/04/2008') == '04/18/2008'
    a__ convert_eu_to_us_date('12/12/2014') == '12/12/2014'
    a__ convert_eu_to_us_date('1/3/2004') == '03/01/2004'
