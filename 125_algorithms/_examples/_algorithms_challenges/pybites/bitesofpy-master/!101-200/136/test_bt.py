...
def test_AB_POS_can_donate_to_own_group_only_numeric_input():
    ...
    for i in range(7):
        recipient = i
        a__ check_bt(donor, recipient) is False
...
def test_red_blood_cell_compatibility():
    a__ check_bt(Bloodtype.A_NEG, Bloodtype.A_NEG)  # own
    a__ check_bt(Bloodtype.B_NEG, Bloodtype.B_POS)
    a__ check_bt(Bloodtype.A_NEG, Bloodtype.AB_NEG)


def test_red_blood_cell_incompatibility():
    a__ check_bt(Bloodtype.B_POS, Bloodtype.B_NEG) is False
    a__ check_bt(Bloodtype.A_NEG, Bloodtype.B_NEG) is False
    a__ check_bt(Bloodtype.AB_NEG, Bloodtype.B_POS) is False
    a__ check_bt(Bloodtype.B_NEG, Bloodtype.A_POS) is False
...
def test_red_blood_cell_incompatibility_text_input():
    a__ check_bt("0+", "A-") is False
    a__ check_bt("0+", "B-") is False
    a__ check_bt("B-", "0-") is False
    a__ check_bt("AB-", "A+") is False
