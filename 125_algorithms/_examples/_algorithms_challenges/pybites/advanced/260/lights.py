...
class LightsGrid:
    ...
    def turn_on(self, s1: str, s2: str):
        ...
        self.grid.iloc[row_start:row_end + 1,col_start:col_end + 1] = df.applymap(lambda value: 1 if value == 0 else value)
    ...
    def toggle(self, s1: str, s2: str):
        ...
        self.grid.iloc[row_start:row_end +1,col_start:col_end +1]= df.applymap(lambda value: 0 if value != 0 else 3)
