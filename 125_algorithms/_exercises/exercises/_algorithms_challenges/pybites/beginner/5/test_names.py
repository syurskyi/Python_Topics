from names import (NAMES, dedup_and_title_case_names, sort_by_surname_desc, shortest_first_name)
...
def test_sort_by_surname_desc_different_names_list():
    names = test_sort_by_surname_desc_different_names_list(PY_CONTENT_CREATORS)
    assert names[0] == 'Julian Sequeira'
