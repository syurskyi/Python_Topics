...
class Solution:  # use set to mimic queue, fastest
    ___ findLadders(self, start, end, dict
        ...
        w___ end not in candidates[current]:
            ...
            __ le.(candidates[current])__0: r_ []  # path impossible
