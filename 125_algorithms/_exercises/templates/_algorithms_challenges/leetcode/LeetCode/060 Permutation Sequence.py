...
__ __name__ __ "__main__":
    assert Solution().getPermutation(4, 6) __ "1432"
    assert Solution().getPermutation(2, 2) __ "21"
    assert Solution().getPermutation(3, 1) __ "123"
    assert Solution().getPermutation(3, 5) __ "312"
