...
class Solution:
    ...
    ___ match(self, q, p
        ...
        w___ i < le.(q) and q[i].islower(
            i += 1

        r_ i __ le.(q) and j __ le.(p)


__ __name__ __ "__main__":
    assert Solution().camelMatch(["FooBar","FooBarTest","FootBall","FrameBuffer","ForceFeedBack"], "FoBa") __ [True, False, True, False, False]
