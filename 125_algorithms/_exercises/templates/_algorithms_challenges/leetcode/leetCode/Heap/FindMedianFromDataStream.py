...
c.. MedianFinder o..
    ...
    ___ __init__(self
        ...
        """
        self.stream_data_left   # list
        heapq.heapify(self.stream_data_left)
        self.stream_data_right   # list
...
#             heapq.heappush(self.stream_data_left, -pop)
        __ n.. self.stream_data_left:
            heapq.heappush(self.stream_data_left, -num)
            r_
        
        __ n.. self.stream_data_right:
            __ num > -self.stream_data_left[0]:
                heapq.heappush(self.stream_data_right, num)
            ____
        ...
        __ l..(self.stream_data_right) __ l..(self.stream_data_left
            __ num > self.stream_data_right[0]:
                heapq.heappush(self.stream_data_right, num)
                pop = heapq.heappop(self.stream_data_right)
                heapq.heappush(self.stream_data_left, -pop)
            ...
            ____
                heapq.heappush(self.stream_data_left, -num)
        ____ l..(self.stream_data_left) > l..(self.stream_data_right
            __ num > self.stream_data_right[0]:
                heapq.heappush(self.stream_data_right, num)
            ____
                heapq.heappush(self.stream_data_left, -num)
    ...
    ___ findMedian(self
        ...
        :rtype: float
        """
        length = l..(self.stream_data_left) + l..(self.stream_data_right)
        __ length % 2 __ 0:
            r_ float((-self.stream_data_left[0] + self.stream_data_right[0])) / 2.0
        ____
            r_ -self.stream_data_left[0]
