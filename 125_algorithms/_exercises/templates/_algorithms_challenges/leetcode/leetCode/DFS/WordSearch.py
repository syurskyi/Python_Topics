...
c.. Solution o..
    ...
    ___ exist  board, word
        ...
        :rtype: bool
        """
        ___ i, d __ enumerate(board
            ___ i2, d2 __ enumerate(d
                __ d2 __ word[0]:
    ...
    ___ search  board, x, y, word
        ...
        __ y-1 >= 0:
            __ board[y-1][x] != '#':
                __ self.search(board, x, y-1, word # u
                    r_ True
        # down
        __ y+1 < l..(board
            __ board[y+1][x] != '#':
                __ self.search(board, x, y+1, word #d
                    r_ True
        # left
        __ x-1 >= 0:
            __ board[y][x-1] != '#':
                __ self.search(board, x-1, y, word #l
                    r_ True
