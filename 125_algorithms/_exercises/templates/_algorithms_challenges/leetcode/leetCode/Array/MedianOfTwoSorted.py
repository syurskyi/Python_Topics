...
c.. Solution o..
    ...
    ___ findMedianSortedArrays  nums1, nums2
        ...
        length = l..(nums1) + l..(nums2)
        __ length <= 2:
            r_ s..(nums1+nums2) / length
        raw_length = length
        ...
        _____ length > 1:
            ...
            __ nums1:
                __ reduce_value > l..(nums1
                    reduce_value = l..(nums1)
            __ nums2:
                __ reduce_value > l..(nums2
                    reduce_value = l..(nums2)
                
            nums1_k_value = nums1[reduce_value-1] __ nums1 else float('inf')
            nums2_k_value = nums2[reduce_value-1] __ nums2 else float('inf')

            __ nums1_k_value < nums2_k_value:
