...
c.. Solution o..
    ...
    ___ findMedianSortedArrays  nums1, nums2
        ...
        __ length & 0x1:
            r_ self.find_kth_num(nums1, 0, n1, nums2, 0, n2, (length + 1) / 2)
        ____
            r_ (self.find_kth_num(nums1, 0, n1, nums2, 0, n2, length / 2) +
                    self.find_kth_num(nums1, 0, n1, nums2, 0, n2, length / 2 + 1)) / 2.0

    ___ find_kth_num  list1, begin1, end1, list2, begin2, end2, k
        ...
        __ n1 > n2:
            r_ self.find_kth_num(list2, begin2, end2, list1, begin1, end1, k)
        __ n1 __ 0:
            r_ list2[begin2 + k - 1]
        __ k __ 1:
        ...
        ____ list1[begin1 + t1 - 1] > list2[begin2 + t2 - 1]:
            r_ self.find_kth_num(list1, begin1, begin1 + t1, list2, begin2 + t2, end2, k - t2)
        ____
            r_ list1[begin1 + t1 - 1]
