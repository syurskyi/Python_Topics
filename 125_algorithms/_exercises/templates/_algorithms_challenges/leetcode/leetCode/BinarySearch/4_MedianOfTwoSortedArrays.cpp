...
public:
    ...
    */
    double findMedianSortedArrays(vector<int>& nums1, vector<int>& nums2) {
        ...
        int l.. = len1 + len2;
        __(l.. & 0x1 __ 1){
            r_ find_kth(nums1, 0, len1, nums2, 0, len2, (l..+1)/2);
        }
        else{
            r_ (find_kth(nums1, 0, len1, nums2, 0, len2, (l..)/2) +
                    find_kth(nums1, 0, len1, nums2, 0, len2, (l..)/2+1)) / 2.0;
        }
    }
    ...
    int find_kth(vector<int>& list1, int begin1, int end1,
        ...
        */
        ...
        __(len1 > len2){
            r_ find_kth(list2, begin2, end2, list1, begin1, end1, k);
        }
        __(len1 __ 0){
            r_ list2[begin2+k-1];
        }
        ...
        else __(list1[begin1+t1-1] > list2[begin2+t2-1]){
            r_ find_kth(list1, begin1, begin1+t1, list2, begin2+t2, end2, k-t2);
        }
        else{
