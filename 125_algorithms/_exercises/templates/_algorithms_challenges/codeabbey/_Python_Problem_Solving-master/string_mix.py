...
s1 = ''.join(i ___ i in input() __ i.islower())
s2 = ''.join(i ___ i in input() __ i.islower())
...
___ mix(s1,s2
    ...
    s1 = ''.join(i ___ i in s1 __ i.islower())
    s2 = ''.join(i ___ i in s2 __ i.islower())
...
#here the string is sorted on the basis of the length of the string
    ...
    ___ i in range(le.(res_string)):
        ___ j in range(0,le.(res_string)-1
    ...
    main_string = '/'.join(str(e) ___ e in res_string)
    r_ main_string
