...
from all_your_base ______ rebase
...
class AllYourBaseTests(unittest.TestCase
    ...
    ___ test_input_base_is_one(self
    ...
    ___ test_output_base_is_one(self
        with self.assertRaisesWithMessage(ValueError
            rebase(2, [1, 0, 1, 0, 1, 0], 1)

    ___ test_output_base_is_zero(self
        with self.assertRaisesWithMessage(ValueError
            rebase(10, [7], 0)

    ___ test_output_base_is_negative(self
        with self.assertRaisesWithMessage(ValueError
            rebase(2, [1], -7)
