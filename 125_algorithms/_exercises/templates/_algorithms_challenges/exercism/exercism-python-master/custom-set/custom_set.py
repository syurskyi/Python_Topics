...
class CustomSet(object
    ...
    ___ issubset(self, other
        r_ all(e in other ___ e in self._store.values())

    ___ isdisjoint(self, other
        r_ not any(e in other ___ e in self._store.values())
    ...
    ___ __add__(self, other
        intersection = CustomSet()
        ___ e in chain(self._store.values(), other._store.values()):
            intersection.add(e)
        r_ intersection
