...
from word_search ______ WordSearch, Point
...
class WordSearchTests(unittest.TestCase
    ...
    ___ test_left_to_right_word_ten_lines(self
        puzzle = ['jefblpepre',
                  'camdcimgtc',
                  'oivokprjsm',
                  'pbwasqroua',
    ...
    ___ test_left_to_right_word_ten_lines_different_position(self
        puzzle = ['jefblpepre',
                  'camdcimgtc',
                  'oivokprjsm',
                  'pbwasqroua',
    ...
    ___ test_different_left_to_right_word_ten_lines(self
        puzzle = ['jefblpepre',
                  'camdcimgtc',
                  'oivokprjsm',
                  'pbwasqroua',
    ...
    ___ test_single_word_right_to_left(self
        puzzle = ['rixilelhrs']
    ...
    ___ test_horizontal_words_different_directions(self
        self.assertEqual(
