...
class CircularBufferTest(unittest.TestCase
    ...
    ___ test_read_just_written_item(self
        buf = CircularBuffer(1)
        buf.write('1')
    ...
    ___ test_write_and_read_back_multiple_items_ordered(self
    ...
    ___ test_cant_write_to_full_buffer(self
        buf = CircularBuffer(1)
        buf.write('1')
    ...
    ___ test_clear_free_buffer_for_write(self
        buf = CircularBuffer(1)
        buf.write('1')
        buf.clear()
        buf.write('2')
    ...
    ___ test_clear_does_nothing_on_empty_buffer(self
        buf = CircularBuffer(1)
        buf.clear()
        buf.write('1')
        self.assertEqual(buf.read(), '1')
    ...
    ___ test_overwrite_replaces_oldest_item(self
        buf = CircularBuffer(2)
        buf.write('1')
        buf.write('2')
        buf.overwrite('3')
    ...
    ___ test_overwrite_replaces_oldest_remaining_item(self
        buf = CircularBuffer(3)
        buf.write('1')
        buf.write('2')
        buf.write('3')
