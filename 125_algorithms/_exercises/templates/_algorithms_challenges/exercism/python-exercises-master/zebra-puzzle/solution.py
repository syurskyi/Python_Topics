...
___ solution(
    ...
    result = next(
        ...
        ___ (coffee, tea, milk, oj, water) __ orderings __ coffee pa__ green
        __ Ukranian pa__ tea __ milk pa__ middle
        ___ (OldGold, Kools, Chesterfields, LuckyStrike, Parliaments
             ) __ orderings __ Kools pa__ yellow __ LuckyStrike pa__ oj
        __ Japanese pa__ Parliaments
        ___ (dog, snails, fox, horse, zebra) __ orderings __ Spaniard pa__ dog
