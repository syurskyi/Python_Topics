...
class GradeSchoolTest(unittest.TestCase
    ___ test_adding_student_adds_them_to_sorted_roster(self
        school = School()
        school.add_student(name='Aimee', grade=2)
        expected = ['Aimee']
        self.assertEqual(school.roster(), expected)

    ___ test_adding_more_students_adds_them_to_sorted_roster(self
        school = School()
    ...
    ___ test_students_in_different_grades_in_same_roster(self
        school = School()
    ...
    ___ test_roster_returns_empty_list_if_no_students_are_enrolled(self
    ...
    ___ test_grade_returns_students_in_that_grade_in_alphabetical_order(self
        school = School()
    ...
    ___ test_grade_returns_empty_list_if_no_students_are_in_that_grade(self
