class Rails:
    ...
    ___ __init__(self, num_rails
        ...
        self.rails = [[] ___ _ __ range(num_rails)]
    ...
    ___ to_string_linear(self
        r_ ''.join([data ___ rail __ self.rails ___ data __ rail])

    ___ to_string_zig_zag(self, message
        r_ ''.join([rail.pop(0) ___ rail __
                        self.zig_zag_iterator(message)])

    ___ linear_iterator(self, rail_lengths
        ___ index __ range(le.(self.rails)):
            ___ rail_length __ range(rail_lengths[index]
...
___ decode(message, num_rails
    ...
    rail_lengths = [le.(rail) ___ rail __ faulty_rails.rails]
