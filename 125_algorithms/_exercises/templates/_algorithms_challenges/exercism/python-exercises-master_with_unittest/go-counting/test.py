...
c_ GoCountingTest(unittest.TestCase):
    ...
    ___ test_one_territory_is_the_whole_board
        ...
        assertSetEqual(territories[go_counting.BLACK], set())
        assertSetEqual(territories[go_counting.WHITE], set())
    ...
    ___ test_two_territories_rectangular_board
        ...
        assertSetEqual(territories[go_counting.NONE], set())
