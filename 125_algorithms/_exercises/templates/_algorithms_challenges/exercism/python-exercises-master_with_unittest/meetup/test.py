...
class MeetupTest(unittest.TestCase):
    ...
    ___ test_first_tuesday_of_june_2013(self):
        self.assertEqual(
            meetup_day(2013, 6, 'Tuesday', '1st'), date(2013, 6, 4))

    ___ test_first_wednesday_of_july_2013(self):
        self.assertEqual(
            meetup_day(2013, 7, 'Wednesday', '1st'), date(2013, 7, 3))

    ___ test_first_wednesday_of_august_2013(self):
        self.assertEqual(
            meetup_day(2013, 8, 'Wednesday', '1st'), date(2013, 8, 7))

    ___ test_first_thursday_of_september_2013(self):
        self.assertEqual(
            meetup_day(2013, 9, 'Thursday', '1st'), date(2013, 9, 5))

    ___ test_first_thursday_of_october_2013(self):
        self.assertEqual(
            meetup_day(2013, 10, 'Thursday', '1st'), date(2013, 10, 3))

    ___ test_first_friday_of_november_2013(self):
        self.assertEqual(
            meetup_day(2013, 11, 'Friday', '1st'), date(2013, 11, 1))

    ___ test_first_friday_of_december_2013(self):
        self.assertEqual(
            meetup_day(2013, 12, 'Friday', '1st'), date(2013, 12, 6))

    ___ test_first_saturday_of_january_2013(self):
        self.assertEqual(
            meetup_day(2013, 1, 'Saturday', '1st'), date(2013, 1, 5))

    ___ test_first_saturday_of_february_2013(self):
        self.assertEqual(
            meetup_day(2013, 2, 'Saturday', '1st'), date(2013, 2, 2))

    ___ test_first_sunday_of_march_2013(self):
        self.assertEqual(
            meetup_day(2013, 3, 'Sunday', '1st'), date(2013, 3, 3))

    ___ test_first_sunday_of_april_2013(self):
        self.assertEqual(
            meetup_day(2013, 4, 'Sunday', '1st'), date(2013, 4, 7))

    ___ test_second_monday_of_march_2013(self):
        self.assertEqual(
    ...
    ___ test_second_tuesday_of_may_2013(self):
        self.assertEqual(
            meetup_day(2013, 5, 'Tuesday', '2nd'), date(2013, 5, 14))

    ___ test_second_tuesday_of_june_2013(self):
        self.assertEqual(
            meetup_day(2013, 6, 'Tuesday', '2nd'), date(2013, 6, 11))

    ___ test_second_wednesday_of_july_2013(self):
        self.assertEqual(
            meetup_day(2013, 7, 'Wednesday', '2nd'), date(2013, 7, 10))

    ___ test_second_wednesday_of_august_2013(self):
        self.assertEqual(
            meetup_day(2013, 8, 'Wednesday', '2nd'), date(2013, 8, 14))

    ___ test_second_thursday_of_september_2013(self):
        self.assertEqual(
            meetup_day(2013, 9, 'Thursday', '2nd'), date(2013, 9, 12))

    ___ test_second_thursday_of_october_2013(self):
        self.assertEqual(
            meetup_day(2013, 10, 'Thursday', '2nd'), date(2013, 10, 10))

    ___ test_second_friday_of_november_2013(self):
        self.assertEqual(
            meetup_day(2013, 11, 'Friday', '2nd'), date(2013, 11, 8))

    ___ test_second_friday_of_december_2013(self):
        self.assertEqual(
            meetup_day(2013, 12, 'Friday', '2nd'), date(2013, 12, 13))

    ___ test_second_saturday_of_january_2013(self):
        self.assertEqual(
            meetup_day(2013, 1, 'Saturday', '2nd'), date(2013, 1, 12))

    ___ test_second_saturday_of_february_2013(self):
        self.assertEqual(
            meetup_day(2013, 2, 'Saturday', '2nd'), date(2013, 2, 9))

    ___ test_second_sunday_of_march_2013(self):
        self.assertEqual(
            meetup_day(2013, 3, 'Sunday', '2nd'), date(2013, 3, 10))

    ___ test_second_sunday_of_april_2013(self):
        self.assertEqual(
            meetup_day(2013, 4, 'Sunday', '2nd'), date(2013, 4, 14))

    ___ test_third_monday_of_march_2013(self):
        self.assertEqual(
            meetup_day(2013, 3, 'Monday', '3rd'), date(2013, 3, 18))

    ___ test_third_monday_of_april_2013(self):
        self.assertEqual(
            meetup_day(2013, 4, 'Monday', '3rd'), date(2013, 4, 15))

    ___ test_third_tuesday_of_may_2013(self):
        self.assertEqual(
            meetup_day(2013, 5, 'Tuesday', '3rd'), date(2013, 5, 21))

    ___ test_third_tuesday_of_june_2013(self):
        self.assertEqual(
            meetup_day(2013, 6, 'Tuesday', '3rd'), date(2013, 6, 18))

    ___ test_third_wednesday_of_july_2013(self):
        self.assertEqual(
            meetup_day(2013, 7, 'Wednesday', '3rd'), date(2013, 7, 17))

    ___ test_third_wednesday_of_august_2013(self):
        self.assertEqual(
    ...
    ___ test_third_thursday_of_october_2013(self):
        self.assertEqual(
            meetup_day(2013, 10, 'Thursday', '3rd'), date(2013, 10, 17))

    ___ test_third_friday_of_november_2013(self):
        self.assertEqual(
            meetup_day(2013, 11, 'Friday', '3rd'), date(2013, 11, 15))

    ___ test_third_friday_of_december_2013(self):
        self.assertEqual(
            meetup_day(2013, 12, 'Friday', '3rd'), date(2013, 12, 20))

    ___ test_third_saturday_of_january_2013(self):
        self.assertEqual(
            meetup_day(2013, 1, 'Saturday', '3rd'), date(2013, 1, 19))

    ___ test_third_saturday_of_february_2013(self):
        self.assertEqual(
            meetup_day(2013, 2, 'Saturday', '3rd'), date(2013, 2, 16))

    ___ test_third_sunday_of_march_2013(self):
        self.assertEqual(
            meetup_day(2013, 3, 'Sunday', '3rd'), date(2013, 3, 17))

    ___ test_third_sunday_of_april_2013(self):
        self.assertEqual(
            meetup_day(2013, 4, 'Sunday', '3rd'), date(2013, 4, 21))

    ___ test_fourth_monday_of_march_2013(self):
        self.assertEqual(
            meetup_day(2013, 3, 'Monday', '4th'), date(2013, 3, 25))

    ___ test_fourth_monday_of_april_2013(self):
        self.assertEqual(
            meetup_day(2013, 4, 'Monday', '4th'), date(2013, 4, 22))

    ___ test_fourth_tuesday_of_may_2013(self):
        self.assertEqual(
            meetup_day(2013, 5, 'Tuesday', '4th'), date(2013, 5, 28))

    ___ test_fourth_tuesday_of_june_2013(self):
        self.assertEqual(
            meetup_day(2013, 6, 'Tuesday', '4th'), date(2013, 6, 25))

    ___ test_fourth_wednesday_of_july_2013(self):
        self.assertEqual(
            meetup_day(2013, 7, 'Wednesday', '4th'), date(2013, 7, 24))

    ___ test_fourth_wednesday_of_august_2013(self):
        self.assertEqual(
            meetup_day(2013, 8, 'Wednesday', '4th'), date(2013, 8, 28))

    ___ test_fourth_thursday_of_september_2013(self):
        self.assertEqual(
            meetup_day(2013, 9, 'Thursday', '4th'), date(2013, 9, 26))

    ___ test_fourth_thursday_of_october_2013(self):
        self.assertEqual(
            meetup_day(2013, 10, 'Thursday', '4th'), date(2013, 10, 24))

    ___ test_fourth_friday_of_november_2013(self):
        self.assertEqual(
            meetup_day(2013, 11, 'Friday', '4th'), date(2013, 11, 22))

    ___ test_fourth_friday_of_december_2013(self):
        self.assertEqual(
            meetup_day(2013, 12, 'Friday', '4th'), date(2013, 12, 27))

    ___ test_fourth_saturday_of_january_2013(self):
        self.assertEqual(
            meetup_day(2013, 1, 'Saturday', '4th'), date(2013, 1, 26))

    ___ test_fourth_saturday_of_february_2013(self):
        self.assertEqual(
    ...
    ___ test_fourth_sunday_of_april_2013(self):
        self.assertEqual(
            meetup_day(2013, 4, 'Sunday', '4th'), date(2013, 4, 28))

    ___ test_last_monday_of_march_2013(self):
        self.assertEqual(
            meetup_day(2013, 3, 'Monday', 'last'), date(2013, 3, 25))

    ___ test_last_monday_of_april_2013(self):
        self.assertEqual(
            meetup_day(2013, 4, 'Monday', 'last'), date(2013, 4, 29))

    ___ test_last_tuesday_of_may_2013(self):
        self.assertEqual(
            meetup_day(2013, 5, 'Tuesday', 'last'), date(2013, 5, 28))

    ___ test_last_tuesday_of_june_2013(self):
        self.assertEqual(
            meetup_day(2013, 6, 'Tuesday', 'last'), date(2013, 6, 25))

    ___ test_last_wednesday_of_july_2013(self):
        self.assertEqual(
            meetup_day(2013, 7, 'Wednesday', 'last'), date(2013, 7, 31))

    ___ test_last_wednesday_of_august_2013(self):
        self.assertEqual(
            meetup_day(2013, 8, 'Wednesday', 'last'), date(2013, 8, 28))

    ___ test_last_thursday_of_september_2013(self):
        self.assertEqual(
    ...
    ___ test_last_friday_of_november_2013(self):
        self.assertEqual(
            meetup_day(2013, 11, 'Friday', 'last'), date(2013, 11, 29))

    ___ test_last_friday_of_december_2013(self):
        self.assertEqual(
            meetup_day(2013, 12, 'Friday', 'last'), date(2013, 12, 27))

    ___ test_last_saturday_of_january_2013(self):
        self.assertEqual(
            meetup_day(2013, 1, 'Saturday', 'last'), date(2013, 1, 26))

    ___ test_last_saturday_of_february_2013(self):
        self.assertEqual(
            meetup_day(2013, 2, 'Saturday', 'last'), date(2013, 2, 23))

    ___ test_last_sunday_of_march_2013(self):
        self.assertEqual(
            meetup_day(2013, 3, 'Sunday', 'last'), date(2013, 3, 31))

    ___ test_last_sunday_of_april_2013(self):
        self.assertEqual(
    ...
    ___ test_last_sunday_of_february_2015(self):
        self.assertEqual(
