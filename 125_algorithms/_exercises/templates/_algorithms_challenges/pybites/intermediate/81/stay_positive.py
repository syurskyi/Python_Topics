...
#             polarity=0.8
#       ? t.._ "This is some masterful reporting by ... It's also an "
...
#
#
# ___ filter_tweets_on_polarity tweets keep_positive_T..
...
#       __ ?
#             positive tweet ___ ? __ ? __ ?.p.. > 0
#             r.. ?
#       ____
#             negative tweet ___ ? __ ? __ ?.p.. < 0
#             r.. ?
#
#
