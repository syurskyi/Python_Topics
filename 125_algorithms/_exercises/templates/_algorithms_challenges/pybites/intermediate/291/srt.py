...
#    """
#    sections_raw word.s.. ___ ? __ ?.s...s.. "\n" __ ? !_ ""
#    sections_clean ? i-3|? ___ ? __ r.. 3, l.. ? +1, 3
#    sections_ranking    # dict
#
#    ___ section __ s..
#       start, stop ? 1 .s.. " --> "
#       total_chars l.. ? 2
#       start_h, start_m, start_s s__.s.. ":"
#       stop_h, stop_m, stop_s s__.s.. ":"
#       start t.. h.._i.. ? m.._i.. ? s.._i.. ? |2
#       stop t.. h.._i.. ? m.._i.. ? s.._i.. ? |2
#       time_delta ? - ?
#       s.. i.. s.. 0 t.. / t__.s..
#
#    r.. s.. s.. k.._s__.g.. r.._T..
