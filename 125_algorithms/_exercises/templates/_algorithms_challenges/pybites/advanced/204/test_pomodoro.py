...
async ___ test_break_time(capfd):
    ...
    ... "[1]" __ output
    ... f"Time for a {int(delay/60)} min break!" __ output
...
async ___ test_session(capfd):
    ...
    ... anno["work_length"] __ Union[int, float]
    ... anno["short_break_length"] __ Union[int, float]
    ... anno["long_break_length"] __ Union[int, float]
    ... anno["return"] __ N..
...
async ___ test_main(capfd):
    ...
    ... anno["short_break_length"] __ Union[int, float]
    ... anno["long_break_length"] __ Union[int, float]
    ... anno["lunch_length"] __ Union[int, float]
    ... anno["return"] __ N..
