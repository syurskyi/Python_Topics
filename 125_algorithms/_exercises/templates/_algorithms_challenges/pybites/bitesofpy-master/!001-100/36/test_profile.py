...
from profile ______ get_profile
...
___ test_get_profile_dict(
    assert get_profile('tim', 36) __ {'name': 'tim', 'age': 36}


___ test_get_profile_one_sport(
    expected = {'name': 'tim', 'age': 36,
                'sports': ['tennis']}
    assert get_profile('tim', 36, 'tennis') __ expected


___ test_get_profile_two_sports(
    expected = {'name': 'tim', 'age': 36,
                'sports': ['basketball', 'tennis']}
    assert get_profile('tim', 36, 'tennis', 'basketball') __ expected
