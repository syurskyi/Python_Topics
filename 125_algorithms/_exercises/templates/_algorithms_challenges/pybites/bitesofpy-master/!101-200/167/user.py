class User:
    ...
    ___ get_full_name(self
        ...
        """
        # TODO 1: you code
        r_ f'{self.first_name} {self.last_name}'.title()
    ...
    ___ username(self
        ...
        """
        # TODO 2: you code
        r_ (self.first_name[0] + self.last_name[:7]).lower()
    ...
    ___ __str__(self
        r_ f'{self.get_full_name} ({self.username})'

    ___ __repr__(self
        """Don't hardcode the class name, hint: use a
           special attribute of self.__class__ ...
        """
        r_ f'{self.__class__.__name__}("{self.first_name}", "{self.last_name}")'
