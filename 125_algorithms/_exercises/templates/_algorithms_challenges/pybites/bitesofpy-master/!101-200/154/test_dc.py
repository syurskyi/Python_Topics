from dataclasses ______ astuple, replace
...
___ test_can_order_bites(bites
    ...
    assert sorted_bites[0].number __ 3
    assert sorted_bites[-1].number __ 1
