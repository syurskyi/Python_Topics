from belts ______ BeltStats, ninja_belts, get_total_points


___ test_get_total_points_given_belts(
    assert get_total_points(ninja_belts) __ 2675
...
___ test_get_total_points_more_belts(
    ...
    assert get_total_points(ninja_belts_updated) __ 6475