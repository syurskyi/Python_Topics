from books ______ (sort_books_by_len_of_title,
...
___ test_sort_books_by_len_of_title(
    ...
    assert last_book.title __ 'Automate the Boring Stuff with Python'
...
___ test_sort_books_by_number_of_page(
    ...
    assert last_book.title __ 'Fluent Python'


___ test_sort_books_by_published_date(
    last_book = sort_books_by_published_date()[-1]
    assert last_book.title __ 'Python Interviews'