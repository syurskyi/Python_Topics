...
#
# # A bunch of `Car`s
# my_car = ?("Toyota Corolla", "black")
# other_car1 = my_car
# other_car2 = ?("Toyota Corolla", "black")
# other_car3 = ?("Toyota Corolla", "red")
# other_car4 = ?("Porsche Cayenne", "black")
#
#
...
#     ... ?.has_same_configuration(list1, list2) __ expected
#
#
# ?p__.m__.p.
#     "car1, car2, expected",
