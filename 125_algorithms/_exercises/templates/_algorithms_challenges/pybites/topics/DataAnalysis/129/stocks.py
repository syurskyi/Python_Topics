...
___ get_industry_cap(industry):
    ...
    locallist = [counter['cap'] for counter in data __ counter['industry'] == industry]
...
___ get_sectors_with_max_and_min_stocks():
    """Return a tuple of the sectors with most and least stocks,
       discard n/a"""
    stock_by_sector = Counter(counter['sector'] for counter in data __ counter['sector'] != 'n/a')
