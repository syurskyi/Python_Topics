...
___ basic_series() __ pd.S..:
    ...
    """
    r.. pd.S..([1,2,3,4,5], name='Fred')


___ float_series() __ pd.S..:
    ...
    """
    r.. pd.S..([f__(i/1000) ___ i __ r..(1001)])


___ alpha_index_series() __ pd.S..:
    ...
    """
    r.. pd.S..([i+1 ___ i __ r..(26)], index=l..(s__.ascii_lowercase


___ object_values_series() __ pd.S..:
    ...
    Don't worry about the series name.
    """
    r.. pd.S..(l..(s__.a..), index=[i+101 ___ i __ r..(26)])
