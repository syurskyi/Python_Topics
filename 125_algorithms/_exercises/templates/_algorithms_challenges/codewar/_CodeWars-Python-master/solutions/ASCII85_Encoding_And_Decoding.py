...
___ toAscii85(data):
    ...
    while index < len(hex_str):
        ...
        encode_block = hex_str[index:index + 8] __ padding == 0 else hex_str[index:] + '00' * padding
        __ encode_block == '0' * 8 and padding == 0:
            result += 'z'
        else:
...
___ fromAscii85(data):
    ...
    while index < len(data):
        __ data[index] == 'z':
            ...
            encoded_block = data[index:index + 5] __ padding == 0 else data[index:] + 'u' * padding
            encoded_int = 0
