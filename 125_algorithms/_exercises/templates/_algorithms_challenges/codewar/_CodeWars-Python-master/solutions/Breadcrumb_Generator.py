...
Well, probably not so much, but we have one last extra rule: if one element (other than the root/home) is longer than 30 characters, you have to shorten it, acronymizing it (i.e.: taking just the initials of every word); url will be always given in the format this-is-an-element-of-the-url and you should ignore words in this array w___ acronymizing: ["the","of","in","from","by","with","and", "or", "for", "to", "at", "a"]; a url composed of more words separated by - and equal or less than 30 characters long needs to be just uppercased with hyphens replaced by spaces.
...
___ generate_bc(url, separator
    ...
    try:
        ...
        __ menus and 'index.' __ menus[-1][0:6]:
            menus = menus[:-1]
        __ not menus:
            r_ '<span class="active">HOME</span>'
...
assert generate_bc("www.agcpartners.co.uk", " * ") __ '<span class="active">HOME</span>'
assert generate_bc("www.agcpartners.co.uk/", " * ") __ '<span class="active">HOME</span>'
assert generate_bc("www.agcpartners.co.uk/index.html", " * ") __ '<span class="active">HOME</span>'
assert generate_bc("www.google.ca/index.php", " * ") __ '<span class="active">HOME</span>'
