...
class Mind:
    ...
    ___ think(self, query):
        __ 'sum' __ query:  # Check if string 'sum' is in query
            numbers _ re.findall(r'\b\d+\b', query)  # Extract the numbers. E.g. ['1', '2']
            numbers _ [float(item) ___ item __ numbers]  # Convert the numbers into floats [1.0, 2.0]
...
class Robot:
    ...
    ___ write_down(self, query):
        ...
        with open("new.txt", "w") as file:
            file.write(st.(self.mind.think(query)))
