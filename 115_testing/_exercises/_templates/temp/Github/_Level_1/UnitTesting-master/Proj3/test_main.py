...
c_ TestInterest?.?
    ___ test_simple_interest_type_error
        ...
        aR..(TypeError, Interest().simple_interest, 'init amt', 1, 1)
        aR..(TypeError, Interest().simple_interest, T.., .5, 1)
        aR..(TypeError, Interest().simple_interest, 1+3j, .5, 1)

        aR..(TypeError, Interest().simple_interest, 100, 'rate', 1)
        aR..(TypeError, Interest().simple_interest, 100, T.., 1)
        aR..(TypeError, Interest().simple_interest, 100, 1+3j, 1)

        aR..(TypeError, Interest().simple_interest, 100, .5, 'time')
        aR..(TypeError, Interest().simple_interest, 100, .5, T..)
        aR..(TypeError, Interest().simple_interest, 100, .5, 1+3j)
    ...
    ___ test_compound_interest_type_error
        """ Test all arguements of the function to determine that if rouge type is entered that it is caught """
        aR..(TypeError, Interest().compound_interest, 'init amt', 1, 2)
        aR..(TypeError, Interest().compound_interest, 100, 'rate', 1, 2)
        aR..(TypeError, Interest().compound_interest, 100, .5, 'time', 2)
        aR..(TypeError, Interest().compound_interest, 100, .5, 1, 'compound num')


        aR..(TypeError, Interest().compound_interest, T.., .5, 1, 2)
        aR..(TypeError, Interest().compound_interest, 100, T.., 1, 2)
        aR..(TypeError, Interest().compound_interest, 100, .5, T.., 2)
        aR..(TypeError, Interest().compound_interest, 100, .5, 1, T..)

        aR..(TypeError, Interest().compound_interest, 1+3j, .5, 1, 2)
        aR..(TypeError, Interest().compound_interest, 100, 1+3j, 1, 2)
        aR..(TypeError, Interest().compound_interest, 100, .5, 1+3j, 2)
        aR..(TypeError, Interest().compound_interest, 100, .5, 1, 1+3j)
