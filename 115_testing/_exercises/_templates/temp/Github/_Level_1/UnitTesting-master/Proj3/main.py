...
c_ Interest:
    ...
    ___ simple_interest  init_amt, rate, time
        ...
        __ (type(init_amt) no. __ [float, in.]) o. (type(rate) no. __ [float, in.]) o. (type(time) no. __ [float, in.]
    ...
    ___ compound_interest  init_amt, rate, time, n
        ...
        __ (type(init_amt) no. __ [float, in.]) o. (type(rate) no. __ [float, in.]) o. (type(time) no. __ [float, in.]) o. (type(n) no. __ [float, in.]
            r_ TypeError("Values must be type integer or float")
