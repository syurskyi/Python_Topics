...
c_ Interest:
    ...
    ___ simple_interest  init_amt, rate, time
        ...
        __ (type(init_amt) no. in [float, int]) o. (type(rate) no. in [float, int]) o. (type(time) no. in [float, int]
    ...
    ___ compound_interest  init_amt, rate, time, n
        ...
        __ (type(init_amt) no. in [float, int]) o. (type(rate) no. in [float, int]) o. (type(time) no. in [float, int]) o. (type(n) no. in [float, int]
            r_ TypeError("Values must be type integer or float")
