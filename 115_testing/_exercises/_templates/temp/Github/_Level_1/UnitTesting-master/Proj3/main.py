...
c_ Interest:
    ...
    ___ simple_interest  init_amt, rate, time
        ...
        __ (ty..(init_amt) no. __ [float, __.]) o. (ty..(rate) no. __ [float, __.]) o. (ty..(time) no. __ [float, __.]
    ...
    ___ compound_interest  init_amt, rate, time, n
        ...
        __ (ty..(init_amt) no. __ [float, __.]) o. (ty..(rate) no. __ [float, __.]) o. (ty..(time) no. __ [float, __.]) o. (ty..(n) no. __ [float, __.]
            r_ TypeError("Values must be type integer or float")
