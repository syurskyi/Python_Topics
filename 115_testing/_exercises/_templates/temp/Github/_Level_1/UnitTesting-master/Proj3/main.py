...
c_ Interest:
    ...
    ___ simple_interest  init_amt, rate, time
        ...
        __ (type(init_amt) not in [float, int]) o. (type(rate) not in [float, int]) o. (type(time) not in [float, int]
    ...
    ___ compound_interest  init_amt, rate, time, n
        ...
        __ (type(init_amt) not in [float, int]) o. (type(rate) not in [float, int]) o. (type(time) not in [float, int]) o. (type(n) not in [float, int]
            r_ TypeError("Values must be type integer or float")
