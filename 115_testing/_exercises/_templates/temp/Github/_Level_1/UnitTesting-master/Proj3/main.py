...
c_ Interest:
    ...
    ___ simple_interest  init_amt, rate, time
        ...
        __ (type(init_amt) no. __ [float, __.]) o. (type(rate) no. __ [float, __.]) o. (type(time) no. __ [float, __.]
    ...
    ___ compound_interest  init_amt, rate, time, n
        ...
        __ (type(init_amt) no. __ [float, __.]) o. (type(rate) no. __ [float, __.]) o. (type(time) no. __ [float, __.]) o. (type(n) no. __ [float, __.]
            r_ TypeError("Values must be type integer or float")
