...
c_ AcceptLists(TestFuncAcceptsSequencesMixin, u__.T..
    arg _ [1, 2, 3]

c_ AcceptStrings(TestFuncAcceptsSequencesMixin, u__.T..
    arg _ 'abc'

c_ AcceptTuples(TestFuncAcceptsSequencesMixin, u__.T..
    arg _ (1, 2, 3)
