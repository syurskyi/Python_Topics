...
parent _ MagicMock()
child1 _ MagicMock(return_value_None)
child2 _ MagicMock(return_value_None)

parent.child1 _ child1
parent.child2 _ child2
...
not_a_child _ MagicMock(name_'not-a-child')

mock.attribute _ not_a_child
mock.attribute()
