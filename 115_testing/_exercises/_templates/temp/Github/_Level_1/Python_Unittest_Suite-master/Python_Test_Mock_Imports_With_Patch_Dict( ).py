...
# One situation where mocking can be hard is where you have a local ______ inside a function.
...
w__ patch.dict('sys.modules', {'fooble': mock}
       ______ fooble
...
# 
# This also works for the from module ______ name form:
# 
...
w__ patch.dict('sys.modules', modules
