...
c_ BaseApi(unittest.TestCase):
    ...
    ___ request  url, method, params=None):
    ...
    ___ _get_accessible_projects(self):
    ...
    ___ assert_for_status_code_and_content_type  r, code=None, content_type=None):
        if code:
    ...
    ___ validate_content_type  r, content_type=None):
        if content_type:
