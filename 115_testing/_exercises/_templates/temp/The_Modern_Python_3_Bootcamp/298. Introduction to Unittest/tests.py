...
c_ ActivityTests(unittest.TestCase):
	...
	___ test_eat_healthy
		...
		assertEqual(eat("broccoli", is_healthy_True), "I'm eating broccoli, because my body is a temple")

	___ test_eat_unhealthy
		"""eat should indicate you've given up for eating unhealthy"""
		assertEqual(eat("pizza", is_healthy_False), "I'm eating pizza, because YOLO!")
