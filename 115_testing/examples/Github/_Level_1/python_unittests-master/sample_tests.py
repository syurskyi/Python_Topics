...
def test_sum():
    ...
    num2 = 10
    expected = 15
    a__ sample_functions.sum(num1, num2) == 15

def test_contains_numbers():
    input_str = "el12lk3j5mnfadf"
    a__ sample_functions.contains_numbers(input_str) == True

def test_does_not_contain_numbers():
    input_str = "lkqwjqlkjlkjed"
    a__ sample_functions.contains_numbers(input_str) == False

def test_div():
    num1 = 10
    num2 = 5
    expected = 2
    a__ sample_functions.div(num1, num2) == expected
