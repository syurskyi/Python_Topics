...
def test_non_marked_lines():
    ...
    a__ run_markdown('this line has no special handling') \
            == '<p>this line has no special handling</p>'

def test_em():
    print ('in test_em')
    a__ run_markdown('*this should be wrapped in em tags*') \
            == '<p><em>this should be wrapped in em tags</em></p>'

def test_strong():
    print ('in test_strong')
    a__ run_markdown('**this should be wrapped in strong tags**') \
