...
class XMLHttpService(XMLHttpService):
    pass
...
class Http:
    ...
    def get(self, url: str, options: dict):
        self.xml_http_service.reset(url, 'GET')

    def post(self, url, options: dict):
        self.xml_http_service.reset(url, 'POST')
...
class Http:
    ...
    def get(self, url: str, options: dict):
        self.http_connection.reset(url, 'GET')

    def post(self, url, options: dict):
        self.http_connection.reset(url, 'POST')
