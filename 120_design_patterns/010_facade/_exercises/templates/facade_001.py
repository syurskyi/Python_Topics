...
(e.g., loading programs ____ disk to memory). In this case, the button
...
is independent ____ the underlying implementation. Since the client
...
____ __future__ import print_function
import time
