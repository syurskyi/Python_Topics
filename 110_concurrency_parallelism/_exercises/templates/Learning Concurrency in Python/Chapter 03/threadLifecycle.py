...
# ______ ti..
#
# # A very simple method ___ our thread to execute
# ___ threadWorker
#   # it is only at the point where the thread starts executing
#   # that it's state goes from 'Runnable' to a 'Running'
#   # state
#   print("My ? has entered the 'Running' State")
#
#   # If we call the t__.s..() method then our thread
#   # goes into a not-runnable state. We can do no further work
#   # on this particular thread
#   t__.s.. 10
#   # ? then completes its tasks and terminates
#   print("My ? is terminating")
#
# # At this point __ t__, the thread has no state
# # it hasn't been allocated any system resources
# myThread _ ?.T.. t.._?
#
# # When we call myThread.s.., Python allocates the necessary system
# # resources __ order ___ our thread to run and then calls the thread's
