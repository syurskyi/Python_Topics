    ...
    if is_nuke():
        ...
        if nuke_exe_fixed and debug:
            ...
            if debug:
                ...
                print '>>> ', nuke_versions
            for version in nuke_versions:
                if platform.system() == 'Darwin':
                    nuke_executable = full_path.format(nuke=version)
                else:
                    nuke_executable = full_path.format(nuke=version, nuke_major_minor=version.split('v')[0])
