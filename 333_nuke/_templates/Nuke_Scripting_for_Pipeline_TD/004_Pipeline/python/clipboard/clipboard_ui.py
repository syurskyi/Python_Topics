...
class HistoryTableWidget(QTableWidget):
    ___ __init__(self):
        ...
        self.horizontalHeader().setStretchLastSection T..
        self.verticalHeader().setVisible F..
